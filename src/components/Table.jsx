    ...
    return(
        ...
        <div className={` w-max md:w-full flex flex-col mx-auto p-2`}>
            <div className={` w-full  p-2 h-32 mt-20 bg-dark-blue-1 mx-auto rounded-tl-md rounded-tr-md`}>
                ...
                <div className={` w-full h-auto mb-10 bg-dark-blue-1 mx-auto rounded-bl-md rounded-br-md text-white flex flex-col sm:flex-row`}>
                    <div className=' w-[600px] lg:w-[1200px] flex flex-wrap'>
                    {
                        (data.previous.page === 0)? <button className=' h-11 px-2 mr-1 text-gray-400 cursor-not-allowed'>Previous</button>:<button onClick={()=>setPage(data.previous.page)} className=' h-11 px-2 mr-1'>Previous</button>
                    }
